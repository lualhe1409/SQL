...
set @m_query='           select  BG.Nombre ''Bodega'', CM.IDCompania ''IDCompania'', CM.Nombre ''Compania'',  CONVERT(VARCHAR(20),  
...
set @gpb=  '      group by cm.IDCompania, cm.Nombre,di.FechaDocumento, di.IDDocumentoIngreso, di.DocumentoReferencia,   
dti.IDDetalleINgreso, dti.idProducto,ORI.Nombre, p.Nombre,     dti.CantidadPedida, dti.CantidadAduana, a.UnidadXCaja, BG.Nombre,
dti.LoteProveedor,  dti.LoteFabricante,dti.FechaCaducidad   order by di.FechaDocumento,  di.IDDocumentoIngreso  '      
